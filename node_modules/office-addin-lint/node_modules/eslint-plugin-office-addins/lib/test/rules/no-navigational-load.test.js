...
const no_navigational_load_1 = __importDefault(require("../../src/rules/no-navigational-load"));
const ruleTester = new rule_tester_1.RuleTester({
    parser: '@typescript-eslint/parser',
});
ruleTester.run('no-navigational-load', no_navigational_load_1.default, {
    valid: [
        {
            code: `
...
//# sourceMappingURL=no-navigational-load.test.js.map