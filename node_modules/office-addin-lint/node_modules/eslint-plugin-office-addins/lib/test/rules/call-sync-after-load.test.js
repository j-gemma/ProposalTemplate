...
const call_sync_after_load_1 = __importDefault(require("../../src/rules/call-sync-after-load"));
const ruleTester = new rule_tester_1.RuleTester({
    parser: '@typescript-eslint/parser',
});
ruleTester.run('call-sync-after-load', call_sync_after_load_1.default, {
    valid: [
        {
            code: `
...
//# sourceMappingURL=call-sync-after-load.test.js.map