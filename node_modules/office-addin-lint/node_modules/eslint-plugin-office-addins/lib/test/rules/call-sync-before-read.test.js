...
const call_sync_before_read_1 = __importDefault(require("../../src/rules/call-sync-before-read"));
const ruleTester = new rule_tester_1.RuleTester({
    parser: '@typescript-eslint/parser',
});
ruleTester.run('call-sync-before-read', call_sync_before_read_1.default, {
    valid: [
        {
            code: `
...
//# sourceMappingURL=call-sync-before-read.test.js.map