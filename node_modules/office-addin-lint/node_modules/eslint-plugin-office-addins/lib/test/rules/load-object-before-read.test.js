...
const load_object_before_read_1 = __importDefault(require("../../src/rules/load-object-before-read"));
const ruleTester = new rule_tester_1.RuleTester({
    parser: '@typescript-eslint/parser',
});
ruleTester.run('load-object-before-read', load_object_before_read_1.default, {
    valid: [
        {
            code: `
...
//# sourceMappingURL=load-object-before-read.test.js.map